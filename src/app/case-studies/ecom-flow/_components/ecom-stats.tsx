    ...
    <div className="grid grid-cols-2 border-b border-[#004225]/12 lg:grid-cols-4">
      {STATS.map((stat, index) => (
        <motion.div
          ...
          className="border-b border-[#004225]/12 px-3 py-4 lg:border-b-0 lg:border-r lg:px-6 lg:py-5 lg:last:border-r-0"
        >
          <div className="mb-1 font-serif text-[28px] font-extrabold leading-none tracking-tight text-primary lg:text-[42px]">
            {stat.value}
          </div>
          <div className="max-w-[140px] text-[11px] leading-[1.5] text-[#7A7467] lg:text-[12px]">
            {stat.label}
          </div>
        </motion.div>
      ))}
