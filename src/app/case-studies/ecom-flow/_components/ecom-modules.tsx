...
function ModuleCard({ module, index }: { module: Module; index: number }) {
  return (
    <motion.div
      ...
      className="cursor-default border-b border-[#004225]/12 p-6 transition-colors hover:bg-[#F5F2EB] lg:border-b-0 lg:border-r lg:p-6 lg:last:border-r-0"
    >
      ...
      <h3 className="mb-2 font-serif text-[22px] font-bold leading-[1.2] tracking-[-0.5px] text-primary">
        {module.title}
      </h3>
...
export function EcomModules() {
  return (
    <section className="border-b border-[#004225]/12" id="modules">
      {/* Header */}
      <div className="mx-auto grid max-w-[1200px] items-end gap-6 px-6 pb-8 pt-12 lg:grid-cols-2 lg:pb-8 lg:pt-12">
        <div>
          <motion.p
          ...
          <motion.h2
            ...
            className="font-serif text-[clamp(36px,4vw,56px)] font-extrabold leading-[1.05] tracking-[-1.5px] text-primary"
          >
            Pick one.
            <br />
        ...
        <motion.p
          ...
          className="max-w-[480px] text-[15px] font-light leading-[1.75] text-[#7A7467]"
        >
